<x-filament-panels::page>
    <div class="p-3 w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div>
            ...
            @else
                <small> - No video to preview. Use the button below to upload a video.</small>
            @endif
