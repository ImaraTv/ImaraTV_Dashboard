<x-filament-panels::page>
    ...
    <div wire:loading.class="opacity-50"
        ...
        <div class="loading_indicator items-center justify-center p-4"
             wire:loading.delay wire:loading wire:target="tableFilters,applyTableFilters,resetTableFiltersForm, updateTableColumnState, nextPage, gotoPage, previousPage">
